...
class HistoryViewTest(TestCase):
    ...
    def test_historys_exists(self):
        ...
        client.credentials(HTTP_AUTHORIZATION=f"Token {team_owner_token}")
        response_error_transaction = client.post(f"/api/transactions/", data=self.error_transaction)
        ...
        self.assertIsInstance(History.objects.get(id=team_owner.history.id), History)
        self.assertEqual(400, response_error_transaction.status_code)